...
public class Showcasedlist_adapter extends RecyclerView.Adapter<Showcasedlist_adapter.ViewHolder> implements CustomDelegates {
    Context context;
    public ArrayList<Home> Autodetailslist;
    View itemLayoutView;

    public Showcasedlist_adapter(Context context, ArrayList<Home> autodetailslist) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        itemLayoutView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.showcased_single, null);
        // create ViewHolder
