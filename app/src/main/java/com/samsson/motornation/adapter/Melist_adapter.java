...
public class Melist_adapter extends RecyclerView.Adapter<Melist_adapter.ViewHolder> implements CustomDelegates {
    Context context;
    public ArrayList<Home> Autodetailslist;
    View itemLayoutView;

    public Melist_adapter(Context context, ArrayList<Home> autodetailslist) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        itemLayoutView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.me_single, null);
        // create ViewHolder
