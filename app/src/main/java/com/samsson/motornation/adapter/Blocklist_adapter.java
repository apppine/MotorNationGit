...
public class Blocklist_adapter extends RecyclerView.Adapter<Blocklist_adapter.ViewHolder> implements CustomDelegates {
    Context context;
    public ArrayList<Home> Autodetailslist;
    View itemLayoutView;

    public Blocklist_adapter(Context context, ArrayList<Home> autodetailslist) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        itemLayoutView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.blocklist, null);
        // create ViewHolder
