...
public class Searchlist_adapter extends RecyclerView.Adapter<Searchlist_adapter.ViewHolder> implements CustomDelegates {
    Context context;
    public ArrayList<Home> Autodetailslist;
    View itemLayoutView;

    public Searchlist_adapter(Context context, ArrayList<Home> autodetailslist) {
