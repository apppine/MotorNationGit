...
public class Commentlist_adapter extends RecyclerView.Adapter<Commentlist_adapter.ViewHolder> implements CustomDelegates {
    Context context;
    public ArrayList<Home> Autodetailslist;
    View itemLayoutView;

    public Commentlist_adapter(Context context, ArrayList<Home> autodetailslist) {
