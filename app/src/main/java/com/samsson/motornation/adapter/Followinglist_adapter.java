...
public class Followinglist_adapter extends RecyclerView.Adapter<Followinglist_adapter.ViewHolder> implements CustomDelegates {
    Context context;
    public ArrayList<Home> Autodetailslist;
    View itemLayoutView;

    public Followinglist_adapter(Context context, ArrayList<Home> autodetailslist) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        itemLayoutView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.following_single, null);
        // create ViewHolder
