...
public class Linearlist_adapter extends RecyclerView.Adapter<Linearlist_adapter.ViewHolder> implements CustomDelegates {
    Context context;
    public ArrayList<Home> Autodetailslist;
    View itemLayoutView;

    public Linearlist_adapter(Context context, ArrayList<Home> autodetailslist) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        itemLayoutView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_linear, null);
        // create ViewHolder
