...
import com.samsson.motornation.adapter.Homelist_adapter;
...
public class HomeFragment extends Fragment {
    ...
    Homelist_adapter homelist_adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        home_recycler=root.findViewById(R.id.recycler_home);
        home_recycler.setLayoutManager(new LinearLayoutManager(getContext()));
        LoadData();
        homelist_adapter=new Homelist_adapter(getContext(),Homelist);
